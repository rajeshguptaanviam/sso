...
DELETE FROM States;
INSERT INTO States(id,state_name,created_at,updated_at) VALUES (1,'AB-Alberta',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP);
INSERT INTO states(id,state_name,created_at,updated_at) VALUES (2,'BC-British Columbia',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP);
INSERT INTO States(id,state_name,created_at,updated_at) VALUES (3,'MB-Manitoba',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP);
INSERT INTO States(id,state_name,created_at,updated_at) VALUES (4,'NB-New Brunswick',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP);
INSERT INTO States(id,state_name,created_at,updated_at) VALUES (5,'NF-Newfoundland',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP);
INSERT INTO States(id,state_name,created_at,updated_at) VALUES (6,'NT-Northwest Territories',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP);
INSERT INTO States(id,state_name,created_at,updated_at) VALUES (7,'NS-Nova Scotia',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP);
INSERT INTO States(id,state_name,created_at,updated_at) VALUES (8,'NU-Nunavut',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP);
INSERT INTO States(id,state_name,created_at,updated_at) VALUES (9,'ON-Ontario',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP);
INSERT INTO States(id,state_name,created_at,updated_at) VALUES (10,'PE-Prince Edward Island',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP);
INSERT INTO States(id,state_name,created_at,updated_at) VALUES (11,'QC-Québec',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP);
INSERT INTO States(id,state_name,created_at,updated_at) VALUES (12,'SK-Saskatchewan',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP);
INSERT INTO States(id,state_name,created_at,updated_at) VALUES (13,'YK-Yukon',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP);
